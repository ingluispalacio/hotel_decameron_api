...
class UpdateHotelConfigurationRequest extends FormRequest
{
    ...
    /**
     * Validation rules for updating a hotel configuration.
     */
    ...
    public function bodyParameters(): array
    {
        return [
            ...
            'quantity' => [
                'description' => 'Updated number of configured rooms.',
                'example' => 10,
            ],
        ];
    }
