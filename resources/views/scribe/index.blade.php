                ...
                <li class="tocify-item level-1" data-unique="hotel-configurations">
                    <a href="#hotel-configurations">Hotel Configurations</a>
                                    ...
                                    <ul id="tocify-subheader-hotel-configurations" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="hotel-configurations-GETapi-v1-hotel-configurations">
                                <a href="#hotel-configurations-GETapi-v1-hotel-configurations">List all hotels with their configurations</a>
                            </li>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>APIs for managing hotel room configurations.</p>
                                ...
                                <h2 id="hotel-configurations-GETapi-v1-hotel-configurations">List all hotels with their configurations</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns a list of all hotels, each containing its configurations with names (not IDs).</p>

<span id="example-requests-GETapi-v1-hotel-configurations">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-v1-hotel-configurations">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-hotel-configurations" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-hotel-configurations"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-hotel-configurations"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-hotel-configurations" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-hotel-configurations">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-hotel-configurations" data-method="GET"
      data-path="api/v1/hotel-configurations"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-hotel-configurations', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-hotel-configurations"
                    onclick="tryItOut('GETapi-v1-hotel-configurations');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-hotel-configurations"
                    onclick="cancelTryOut('GETapi-v1-hotel-configurations');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-hotel-configurations"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-hotel-configurations"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-hotel-configurations"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-hotel-configurations"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
